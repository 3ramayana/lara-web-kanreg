    ...
    <div class="copyright text-center">
        <div
            ...
            <div class="social-links order-first order-lg-last mb-3 mb-lg-0">
                <a href="https://x.com/bknkanreg14" target="_blank"><i class="bi bi-twitter-x"></i></a>
                <a href="https://www.tiktok.com/@bknkanreg14" target="_blank"><i class="bi bi-tiktok"></i></a>
                <a href="https://web.facebook.com/kanreg14bknmanokwari" target="_blank"><i
                        class="bi bi-facebook"></i></a>
                <a href="https://www.instagram.com/bknkanreg14/" target="_blank"><i class="bi bi-instagram"></i></a>
                <a href="https://www.youtube.com/@bknkanreg14" target="_blank"><i class="bi bi-youtube"></i></a>
            </div>
