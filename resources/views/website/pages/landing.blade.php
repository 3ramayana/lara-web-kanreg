                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="post-item position-relative h-100 d-flex flex-column" data-aos="fade-up"
                                    ...
                                    <div class="post-img position-relative overflow-hidden">
                                        ...
                                        <span
                                            class="post-date">{{ \Carbon\Carbon::parse($event['tanggal_pelaksanaan'])->locale('id')->translatedFormat('d F Y') }}</span>
                                    </div>
                ...
                <div class="row">
                    @foreach ($headline as $item)
                        <div class="col-lg-6 mb-4 mb-lg-0">
                            <img src="uploads/{{ $item->thumbnail }}" alt="Image "
                                class="img-fluid img-overlap rounded-4" data-aos="zoom-out"
                                style="height: auto; max-height:auto; min-width:100%;max-width:100%">
                        </div>
